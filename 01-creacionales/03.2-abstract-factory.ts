...
class ElectricCar implements Vehicle {
  assemble(): void {
    console.log("Ensamblando un auto %celéctrico", COLORS.cyan);
  }
}

class GasCar implements Vehicle {
  assemble(): void {
    console.log("Ensamblando un auto %c combustión", COLORS.red);
  }
}

class ElectricEngine implements Engine {
  start(): void {
    console.log("Arrancando motor %celéctrico", COLORS.cyan);
  }
}

class GasEngine implements Engine {
  start(): void {
    console.log("Arrancando motor %c de combustión", COLORS.red);
  }
}
